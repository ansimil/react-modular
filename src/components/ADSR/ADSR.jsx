...
export const ADSR = () => {
  ...
  return (
    <div className='adsrContainer'>
        ...
        <Slider module={"adsr"} label={"D"} valueLabel={(appState.adsrSettings.decay).toFixed(2)} unit={"s"} min={0} max={5} step={0.001} values={appState.adsrSettings.decay} sliderRef={adsrRef} id={"decay"} changeFunction={change}/>
