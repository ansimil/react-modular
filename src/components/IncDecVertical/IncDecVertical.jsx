...
const IncDecVertical = ({value, label, moduleType, id, moduleName, i, limit}) => {
    ...
    return (
        <div className="inc-dec-vertical-inner">
            ...
            <button
            id={label} 
            className={`inc-dec-btn dec-btn-vertical dec-btn${moduleName}${label} btn btn-light`}
            onClick={(e)=> {
            ...
            <button
            id={label}
            className={`inc-dec-btn inc-btn-vertical inc-btn${moduleName}${label} btn btn-light`}
