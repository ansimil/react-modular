    ...
    <div className="moduleSettingsContainer">
        <div className="moduleSettingsInner">
            <div className="slidersContainer">
              ...
              <Slider module={"reverb"} label={"DELAY"} valueLabel={(appState.effectsSettings.reverb.preDelay).toFixed(2)} unit={"s"} min={0} max={2} step={0.0001} values={appState.effectsSettings.reverb.attack} sliderRef={reverbRef} id={"preDelay"} changeFunction={change}/>
