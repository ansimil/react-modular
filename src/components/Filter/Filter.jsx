...
const Filter = () => {
  ...
  return (
    <div className='module-container filterContainer'>
        ...
        <div className="module-settings-container">
            ...
            <div className="rightSideContainer">
                <div className="selectors waveform-selectors filterresponse-selectors">
                    <button 
                    id="lowpass"
                    className={activeType === 'lowpass' ? "btn btn-dark btn-active waveform-selector": "btn btn-dark waveform-selector"}
                    onClick={changeType}
                    >
                    LP
                    </button>
                    ...
                    <button 
                    id="highpass"
                    className={activeType === 'highpass' ? "btn btn-dark btn-active waveform-selector": "btn btn-dark waveform-selector"}
                    onClick={changeType}
                    >
                    HP
                    </button>
                    ...
                    <button
                    id="bandpass"
                    className={activeType === 'bandpass' ? "btn btn-dark btn-active waveform-selector": "btn btn-dark waveform-selector"}
                    onClick={changeType}
                    >
                    BP
                    </button>
                    ...
                    <button 
                    id="notch"
                    className={activeType === 'notch' ? "btn btn-dark btn-active waveform-selector": "btn btn-dark waveform-selector"}
                    onClick={changeType}
                    >
                    N
                    </button>
